...
class App extends Component {
  ...
  componentDidMount = () => {
    const startTransition = 50; // amount of pixels to scroll before the navbar styling changes
    this.scrollFn = evt => {
      ...
      <ThemeProvider theme={theme}>
        <div>
          <Head>
            ...
            <meta
              name='description'
              content='Dynamic Lymphatics provides lymphatic drainage therapy (lymphatic massage) from Trish Romano, CLT, a Casely-Smith certified practitioner.'
